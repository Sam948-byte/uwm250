...
public class DiceGame {
    public static void main(String[] args) {
        ...
        } while (utils.Validator.getValidatedInput("Would you like to play again? y/n\n", "[yn]").equals("y"));

        System.out
                .println("You played " + rounds + " rounds and won " + wins + " times and lost " + losses + " times.");
    }
    ...
    public static String rollDice() {
        ...
        // check for two pair
        if (results[0] == results[1] && results[2] == results[3] || results[0] == results[1] && results[1] == results[3]
                || results[0] == results[2] && results[2] == results[3]) {
            return "TwoPair";
        }
        // check for pair of fours
        if (results[0] == results[1] && results[1] == 4 || results[1] == results[2] && results[2] == 4
                || results[2] == results[3] && results[3] == 4) {
            return "HighPair";
        }
        return "Loss";
